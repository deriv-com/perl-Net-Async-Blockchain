...
sub configure {
    ...
    for my $k (
        qw(rpc_url rpc_timeout rpc_user rpc_password subscription_url subscription_timeout subscription_msg_timeout currency_symbol base_block_number redis_auth redis_host redis_port)
        )
    {
